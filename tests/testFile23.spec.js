...
test('test 23 - Add PersonalBag before start transaction', async ({}, testInfo) => {
await runTest(async (testInfo) => {
    ...
    await startTrs('undefined',0.250,1);
  ...
  }, 'test 23 - Add PersonalBag before start transaction',testInfo);
  });
